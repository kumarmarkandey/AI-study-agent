  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '22px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', borderRadius: '20px', background: 'rgba(245, 158, 11, 0.15)', border: '1px solid rgba(245, 158, 11, 0.3)', color: '#f59e0b', fontWeight: 700, fontSize: '0.88rem' }}>
          <Clock size={16} />
      ...
      {/* Question Card */}
      <div className="glass-panel" style={{ padding: '34px' }}>
        ...
        <h3 style={{ fontSize: '1.35rem', fontWeight: 700, marginBottom: '26px', lineHeight: 1.5, color: 'white' }}>
          {currentQ.question}
        </h3>
        ...
        {/* AI Hint Section */}
        {hints[currentQIndex] && (
          <div style={{ marginTop: '22px', padding: '16px', borderRadius: '12px', background: 'rgba(245, 158, 11, 0.12)', border: '1px solid rgba(245, 158, 11, 0.3)', color: '#f59e0b', fontSize: '0.9rem', lineHeight: 1.5 }}>
            {hints[currentQIndex]}
          </div>
        )}
        ...
        {showExplanation[currentQIndex] && (
          <div style={{ marginTop: '22px', padding: '20px', borderRadius: '14px', background: 'rgba(168, 85, 247, 0.12)', border: '1px solid rgba(168, 85, 247, 0.35)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--accent-violet)', fontWeight: 700, marginBottom: '8px' }}>
              <Sparkles size={16} />
              <span>Explanation & Concept Notes</span>
            </div>
            <p style={{ fontSize: '0.94rem', lineHeight: 1.6, color: '#e2e8f0' }}>
        ...
        {/* Bottom Actions */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '28px', paddingTop: '22px', borderTop: '1px solid var(--border-color)' }}>
          <button onClick={handleGetHint} className="btn-secondary" style={{ padding: '8px 16px', fontSize: '0.86rem' }}>
